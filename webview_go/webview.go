...
/*
#cgo CFLAGS: -I${SRCDIR}/../webview/core/include
#cgo CXXFLAGS: -I${SRCDIR}/../webview/core/include -DWEBVIEW_STATIC
...
type WebView interface {
	...
	// Example: w.SetUserAgent("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36")
